...
CREATE TABLE student (
  ...
  FOREIGN KEY (group_id) REFERENCES student_group (group_id) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE lab_rating (
  ...
  FOREIGN KEY (lab_id) REFERENCES lab_work (lab_id) ON DELETE CASCADE ON UPDATE CASCADE
);
