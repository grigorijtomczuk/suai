namespace lab
{
	partial class Lab10
	{
		...
		private void InitializeComponent()
		{
			...
			buttonIdxIndexType = new Button();
			buttonIdxName = new Button();
			buttonIdxIndex = new Button();
			label2 = new Label();
			label3 = new Label();
			label4 = new Label();
			...
			// groupBox1
			// 
			groupBox1.Controls.Add(buttonIdxIndexType);
			groupBox1.Controls.Add(buttonIdxName);
			groupBox1.Controls.Add(buttonIdxIndex);
			...
			// buttonIdxIndexType
			// 
			buttonIdxIndexType.Location = new Point(453, 133);
			buttonIdxIndexType.Margin = new Padding(4, 5, 4, 5);
			buttonIdxIndexType.Name = "buttonIdxIndexType";
			buttonIdxIndexType.Size = new Size(221, 74);
			buttonIdxIndexType.TabIndex = 5;
			buttonIdxIndexType.Text = "Доступ по типу и индексу";
			buttonIdxIndexType.UseVisualStyleBackColor = true;
			buttonIdxIndexType.Click += buttonIdxIndexType_Click;
			// 
			// buttonIdxName
			// 
			buttonIdxName.Location = new Point(453, 85);
			buttonIdxName.Margin = new Padding(4, 5, 4, 5);
			buttonIdxName.Name = "buttonIdxName";
			buttonIdxName.Size = new Size(221, 38);
			buttonIdxName.TabIndex = 5;
			buttonIdxName.Text = "Доступ по имени";
			buttonIdxName.UseVisualStyleBackColor = true;
			buttonIdxName.Click += buttonIdxName_Click;
			// 
			// buttonIdxIndex
			// 
			buttonIdxIndex.Location = new Point(453, 37);
			buttonIdxIndex.Margin = new Padding(4, 5, 4, 5);
			buttonIdxIndex.Name = "buttonIdxIndex";
			buttonIdxIndex.Size = new Size(221, 38);
			buttonIdxIndex.TabIndex = 5;
			buttonIdxIndex.Text = "Доступ по индексу";
			buttonIdxIndex.UseVisualStyleBackColor = true;
			buttonIdxIndex.Click += buttonIdxIndex_Click;
			// 
			// label2
			// 
		...
		private Button buttonIdxIndex;
		private Button buttonIdxIndexType;
		private Button buttonIdxName;
	}
}