namespace lab
{
	partial class Lab11
	{
		...
		private void InitializeComponent()
		{
			...
			// groupBox1
			// 
			groupBox1.Controls.Add(buttonAddTestFiles);
			...
			// buttonAddTestFiles
			// 
			buttonAddTestFiles.Location = new Point(453, 37);
			buttonAddTestFiles.Margin = new Padding(4, 5, 4, 5);
			buttonAddTestFiles.Name = "buttonAddTestFiles";
			buttonAddTestFiles.Size = new Size(196, 38);
			buttonAddTestFiles.TabIndex = 5;
			buttonAddTestFiles.Text = "Загрузить узлы ФС";
			buttonAddTestFiles.UseVisualStyleBackColor = true;
			buttonAddTestFiles.Click += buttonAddTestFiles_Click;
			// 
			// label2
			// 
		...
		private Button buttonAddTestFiles;
	}
}